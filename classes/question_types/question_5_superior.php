...
class question_5_superior extends question {

    public $type_name = "5-1 Superior - poor"; //loaded to database on install / update
    ...
    function display(&$mform, $form, $data, $order) {
        ...
        $abr = array(
            get_string('scale5_5', 'local_evaluations'),
            get_string('scale5_4', 'local_evaluations'),            
            get_string('scale5_3', 'local_evaluations'),
            get_string('scale5_2', 'local_evaluations'),
            get_string('scale5_1', 'local_evaluations'),
        );
